...
function el_duderino_setup() {
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary', 'el-duderino' ),
	) );
...
function el_duderino_scripts() {
	...
	wp_enqueue_script( 'el-duderino-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'el-duderino-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
